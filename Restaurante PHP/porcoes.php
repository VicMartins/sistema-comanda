...
<div class="row">
    <div class="col s12">
      <ul id="dropdown1" class="dropdown-content">
        ...
        <li class="divider"></li>
        <li class="active"><a href="porcoes.php">Porções</a></li>
  ...
  <div class="col-md-6">
    <div class="ps6">
     ...
     <h2 class="title">Cadastro dos Pratos Principais</h2>
       <label for="bebidas"> Nome do prato: </label>
       <input type="text" name="nome">
      </div>

     <div class="paragarph-center">
       <label for="pratoP"> Valor do prato: </label>
       ...
       <div class="paragarph-center">
         <button id="botão" class="btn btn-warning" type="submit"> Pedido Finalizado</button>
       </div>
   </div>
   </div>
  </div>
